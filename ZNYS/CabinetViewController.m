...
@property (nonatomic,strong) NSNumber * userLevel;   //用户等级
...
- (void)setGloryView{
    ...
    for(NSInteger i = 1;i <= 10;i++)
    {
        ...
        ItemWithState *gloryItem = [[ItemWithState alloc] initWithItemName:[[itemDic objectForKey:[NSString stringWithFormat:@"Level%ld",(long)i]] objectForKey:@"title"]  imageName:littleCar state:state tag:i style:0];
